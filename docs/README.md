...
Current delivery: [2026-09-08 release readiness](implementation-plan/20260908-v1.0-single-pass-release-readiness.md) records completed checks and publication evidence. The user accepted the measured performance costs; [0.2.1 release notes](release-notes/20260908-v0.2.1-single-pass-autofit.md) describe the published release.
